...
function addMarker(place)
{
    ...
    // create click event
    google.maps.event.addListener(marker, "click", function(e) {getArticles(this, place.place_name + ", " + place.admin_name1)});
...
/**
 * Gets articles from geo &
 * displays info window at marker
 */
function getArticles(marker, geo)
{
    // get articles
    ...
    .done(function(data, textStatus, jqXHR) {
        ...
        if (data.length == 0)
        {
            content = "We could not find any related news."
        }
        else
        {
            content = "<h3>" + geo + "</h3>\n<ul>"
            ...
            {
                content += "<li><a href=\"" + data[i].link + "\" target=\"_blank\">" + data[i].title + "</a>";
            }
            content += "</ul>"
        }
